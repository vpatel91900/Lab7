...
public class RPSLSpock {
    ...
    /**
     * isValidPick methode
     * This methode checks if the userPick is a validPick and then returns according
     * @param pick
     * @return cleaned up userinput
     */
    ...
    /**
     * generatePick Methode
     * This methode generatePick for the computer
     * This generates a random number from 0-4 then it will go to the case with that rand number
     * it will pick the string attached to that case number
    ...
    /**
     * isComputerWin methode
     * This are all the possible outcomes for the computer to win
     * @param c_pick computer pick
     * @param h_pick User pick
     * @return Ture or False that tells if the computer won or not
     */
